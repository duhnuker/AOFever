...
import { useWtaPlayerData } from '../../hooks/useWtaPlayerData';
import { useWtaData } from '../../hooks/useWtaData';
import BettingOdds from '../../components/BettingOdds';
import Header from '../../components/Header';
import ScrollVelocity from '../../components/ScrollVelocity';
import DotGrid from '../../components/DotGrid';

const WomensHeadToHead = () => {
    ...
    const { players, loading: playersLoading, error: playersError, getPlayerStats } = useWtaPlayerData();
    const { filters, loading: filtersLoading, error: filtersError } = useWtaData();
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:5000/api/predict/predictwomenswinner', requestPayload);
            ...
            <Container size="4" className='px-2 sm:px-4 md:px-6'>
                ...
                <Flex direction="column" justify="center" align="center" className='min-h-[calc(100vh-80px)]'>
                    <Flex justify="center" className='mb-6'>
                        ...
                        >
                            Women's Head to Head Predictor
                        </Heading>
                    </Flex>
...
export default WomensHeadToHead;
